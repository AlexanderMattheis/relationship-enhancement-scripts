...
between humans and machines. That scripts should easify your life and give you more control over your operating system.

**Hint:** You can install Powershell on your Mac and Linux system, too.
But the scripts were written with Powershell 5.1+ and designed for Windows 10 Version 1703+. 
...
Configures Windows 10 Version 1703+ after installation:
